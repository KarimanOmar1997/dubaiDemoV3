...
//>>built
define(["exports","../output/BlendOptions","../../shaderModules/glsl"],(function(l,o,e){"use strict";l.BlendModes=function(l,c){const b=c.blendMode;b!==o.LayerBlendMode.Normal&&(b===o.LayerBlendMode.Reflect&&l.code.add(e.glsl`float reflectBlend(in float cb, in float cl) {
